...
// app/api/search-index/route.js) alongside Careers listings from
// lib/ats.js. Only what's needed to match against and render a result
// row: no cover images, author bylines, or body content.
...
export const SEARCH_NEWS_QUERY = `
  query SearchNews {
    allNewsPosts(orderBy: publishedAt_DESC, first: 100) {
      title
      slug
      publishedAt
      seoTags {
