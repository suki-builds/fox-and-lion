...
const SOURCE_NAMES = {
  ...
  'aflcmc.af': 'USAF Life Cycle Management Center',
  'airandspace.si': 'National Air and Space Museum',
  asianmilitaryreview: 'Asian Military Review',
  australiandefence: 'Australian Defence Magazine',
  aviationweek:'Aviation Week',
  army:'U.S. Army',
  bbc: 'BBC',
  breakingdefense: 'Breaking Defense',
  bunshun: 'Bunshun Online',
  ...
  defenceconnect: 'Defence Connect',
  ...
  'euro-sd': 'Euro-SD',
  euronews: 'Euronews',
  federalnewsnetwork: 'Federal News Network',
  focustaiwan: 'Focus Taiwan',
  frontlinedefensejournal: 'Frontline Defense',
  ft: 'FT',
  gao: 'U.S. Government Accountability Office',
  'gendai.media': 'Money Gendai',
  'en.globes': 'Globes',
  gov: 'UK Government',
  grounda: 'Ground A',
  highergov: 'HigherGov',
  ...
  iiss: 'IISS',
  interestingengineering: 'Interesting Engineering',
  'investors.palantir': 'Palantir',
  ...
  usatoday: 'USA Today',
  'eu.usatoday': 'USA Today',
  'news.usni': 'USNI News',
  youtube: 'YouTube',
  washingtonpost: 'The Washington Post',
  'world.storm': 'The Storm Media',
};
