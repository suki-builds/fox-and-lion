...
//
// Returned through proxiedImageUrl() so the raw datocms-assets.com host
// never reaches rendered HTML - see app/api/image-proxy/route.js.
export function coverImageSrc(url, { w = 1200, h = 630 } = {}) {
  ...
  return proxiedImageUrl(transformed.toString());
}
